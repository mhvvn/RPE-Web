...
import { LayoutDashboard, FileText, LogOut, Menu, Zap, Book, GraduationCap, Building, Users, ChevronLeft, ChevronRight, BarChart2, Globe } from 'lucide-react';
...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex">
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed md:static inset-y-0 left-0 z-50 bg-sea-900 text-white transform transition-all duration-300 ease-in-out flex flex-col ${
