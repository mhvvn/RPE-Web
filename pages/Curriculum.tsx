...
const Curriculum: React.FC = () => {
  ...
  const handleDownload = () => {
      if (curriculumFile) {
          ...
          alert("Dokumen kurikulum belum tersedia untuk saat ini. Silakan hubungi admin.");
      }
  };

  return (
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen pb-20 pt-10">
                  ...
                  <div className="p-6 overflow-y-auto custom-scrollbar">
                      <div className="space-y-0 text-sm">
                          ...
                          <div className="flex border border-slate-200 dark:border-slate-700 border-b-0">
                              <div className="w-1/3 p-4 bg-slate-50 dark:bg-slate-800 font-medium text-slate-600 dark:text-slate-300 border-r border-slate-200 dark:border-slate-700">Mata Kuliah</div>
                              <div className="w-2/3 p-4 text-slate-800 dark:text-slate-200">{selectedCourse.name}</div>
                          </div>
                          <div className="flex border border-slate-200 dark:border-slate-700 border-b-0">
                              <div className="w-1/3 p-4 bg-slate-50 dark:bg-slate-800 font-medium text-slate-600 dark:text-slate-300 border-r border-slate-200 dark:border-slate-700">Kode</div>
                              <div className="w-2/3 p-4 text-slate-800 dark:text-slate-200">{selectedCourse.code}</div>
                          </div>
                          <div className="flex border border-slate-200 dark:border-slate-700 border-b-0">
                              <div className="w-1/3 p-4 bg-slate-50 dark:bg-slate-800 font-medium text-slate-600 dark:text-slate-300 border-r border-slate-200 dark:border-slate-700">SKS</div>
                              <div className="w-2/3 p-4 text-slate-800 dark:text-slate-200">{selectedCourse.credits}</div>
                          </div>
                          <div className="flex border border-slate-200 dark:border-slate-700 border-b-0">
                              <div className="w-1/3 p-4 bg-slate-50 dark:bg-slate-800 font-medium text-slate-600 dark:text-slate-300 border-r border-slate-200 dark:border-slate-700">Deskripsi Mata Kuliah</div>
      ...
      <div className="max-w-4xl mx-auto px-4 text-center mb-12">
        <h1 className="text-3xl md:text-4xl font-extrabold text-sea-900 dark:text-white uppercase tracking-wide mb-4">
          KURIKULUM
        </h1>
        <div className="w-16 h-1.5 bg-sea-400 mx-auto mb-6 rounded-full"></div>
        ...
        <button 
          ...
          className={`inline-flex items-center px-8 py-3 font-bold rounded-lg shadow-lg transition transform hover:-translate-y-1 ${
              curriculumFile 
        ...
        >
          ...
          {curriculumFile ? 'Unduh Kurikulum (PDF)' : 'Dokumen Belum Tersedia'}
        </button>
      </div>
                ...
                <div className="p-4 sm:p-6 animate-fade-in-down bg-white dark:bg-slate-900">
                  {semesterCourses.length > 0 ? (
                      ...
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700 w-12">No</th>
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700">Kode</th>
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700 min-w-[200px]">Nama</th>
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700 min-w-[150px]">Course</th>
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700 w-16">SKS</th>
                            <th colSpan={3} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white border-r border-slate-100 dark:border-slate-700 border-b">Bobot SKS</th>
                            <th rowSpan={2} className="py-3 px-4 text-center text-sm font-bold text-slate-800 dark:text-white w-20">Silabus</th>
                          </tr>
                          <tr className="border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800">
                            <th className="py-2 px-2 text-center text-xs font-bold text-slate-700 dark:text-slate-300 border-r border-slate-100 dark:border-slate-700">Teori</th>
                            <th className="py-2 px-2 text-center text-xs font-bold text-slate-700 dark:text-slate-300 border-r border-slate-100 dark:border-slate-700">Seminar</th>
                            <th className="py-2 px-2 text-center text-xs font-bold text-slate-700 dark:text-slate-300 border-r border-slate-100 dark:border-slate-700">Praktikum</th>
                          </tr>
                        </thead>
                    ...
                    <div className="text-center py-8 text-slate-500 dark:text-slate-400 italic">
                      Data mata kuliah untuk semester ini belum tersedia.
                    </div>
                  )}
                </div>
              )}
