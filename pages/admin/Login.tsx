        ...
        <form onSubmit={handleLogin} className="p-8 space-y-6">
            ...
            <div>
                ...
                <div className="mt-2 text-xs text-slate-500 bg-slate-50 p-2 rounded">
                    <p className="font-semibold mb-1">Akun Demo (Klik untuk isi):</p>
                    <div className="grid grid-cols-1 gap-1">
                        {USERS_DATA.map(u => (
                            <div key={u.id} className="flex justify-between cursor-pointer hover:text-sea-600" onClick={() => fillDemoCreds(u.username, u.password || '123')}>
