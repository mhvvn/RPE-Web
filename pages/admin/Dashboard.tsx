...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    { label: 'Mahasiswa', value: '452', icon: Users, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Total Views', value: '12.5k', icon: Eye, color: 'text-amber-600', bg: 'bg-amber-50' },
    { label: 'Engagement', value: '+18%', icon: TrendingUp, color: 'text-purple-600', bg: 'bg-purple-50' },
  ];
