...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-0">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden bg-sea-900 group">
        {/* Background Slides */}
          ...
          {HERO_SLIDES.map((_, index) => (
            <button
              ...
              className={`w-3 h-3 rounded-full transition-all duration-300 ${
                index === currentSlide ? 'bg-amber-400 w-8' : 'bg-white/50 hover:bg-white'
              }`}
            />
          ))}
        </div>
      ...
      <section className="py-16 bg-white dark:bg-slate-900 relative z-20 mt-40 shadow-xl border-y border-slate-100 dark:border-slate-800 w-full">
